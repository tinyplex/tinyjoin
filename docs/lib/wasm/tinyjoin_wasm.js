/* @ts-self-types="./tinyjoin_wasm.d.ts" */
...
export class WasmEngine {
     ...
     * @param {number} bridge_version
     * @param {number} operation
     * @param {any} payload
     * @returns {any}
     */
    callStructured(bridge_version, operation, payload) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.wasmengine_callStructured(retptr, this.__wbg_ptr, bridge_version, operation, addHeapObject(payload));
    ...
    constructor(device) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.wasmengine_new(retptr, addHeapObject(device));
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_close_3ff76d616b77703d: function() { return handleError(function (arg0) {
        ...
        __wbg_flush_2ede283e8384d2fd: function() { return handleError(function (arg0) {
        ...
        __wbg_pageCount_6866e98b7eb9d614: function() { return handleError(function (arg0) {
            const ret = getObject(arg0).pageCount();
            return addHeapObject(ret);
        }, arguments); },
        __wbg_prototypesetcall_de8e0d9553586985: function(arg0, arg1, arg2) {
            Uint8Array.prototype.set.call(getArrayU8FromWasm0(arg0, arg1), getObject(arg2));
        },
        __wbg_readPage_a321338f8d5b16ee: function() { return handleError(function (arg0, arg1, arg2, arg3, arg4) {
            const ret = getObject(arg0).readPage(arg1 >>> 0, arg2 >>> 0, getArrayU8FromWasm0(arg3, arg4));
            return addHeapObject(ret);
        }, arguments); },
        ...
        __wbg_writePage_778f8b253e4ac5f2: function() { return handleError(function (arg0, arg1, arg2, arg3, arg4) {
            const ret = getObject(arg0).writePage(arg1 >>> 0, arg2 >>> 0, getArrayU8FromWasm0(arg3, arg4));
            return addHeapObject(ret);
        }, arguments); },
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('tinyjoin_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
